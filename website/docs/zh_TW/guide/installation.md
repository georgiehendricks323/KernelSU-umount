...
您可以從 [GitHub Release](https://github.com/georgiehendricks323/KernelSU-umount/releases) 下載 boot.img，請注意，您應該使用正確版本的 boot.img。例如，如果您的裝置顯示核心是 `android12-5.10.101`，需要下載 `android-5.10.101_yyyy-MM.boot-<format>.img`.
