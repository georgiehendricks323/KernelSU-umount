...
export default defineConfig({
  ...
  themeConfig: {
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/georgiehendricks323/KernelSU-umount' }
    ],
    ...
    editLink: {
        pattern: 'https://github.com/georgiehendricks323/KernelSU-umount/edit/main/website/docs/:path',
